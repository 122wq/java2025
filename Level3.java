...
public class Level3 {
    public static void main(String[] args) {
        String text = "kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT\n" + //
        ...
        Pattern r = Pattern.compile("[^A-Z][A-Z]{3}[a-z][A-Z]{3}[^A-Z]");

        // Now create matcher object.
        Matcher m = r.matcher(text);
        while (m.find( )) 
        {
            System.out.print(m.group(0).charAt(4));
        }
